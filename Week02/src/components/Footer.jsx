        ...
        <Row className="gy-4">
          <Col lg={4} md={6} className="pe-lg-5">
            ...
            <div className="d-flex gap-3 mt-4">
              {/* Placeholder cho các icon social, sử dụng CSS/Bootstrap cơ bản */}
              <a href="#" className="text-light hover-lift" style={{ textDecoration: 'none', fontSize: '1.2rem' }}>📱</a>
              <a href="#" className="text-light hover-lift" style={{ textDecoration: 'none', fontSize: '1.2rem' }}>🌐</a>
              <a href="#" className="text-light hover-lift" style={{ textDecoration: 'none', fontSize: '1.2rem' }}>✉️</a>
            </div>
          </Col>
